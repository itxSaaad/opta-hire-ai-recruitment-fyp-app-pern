...
export default function CandidateApplicationsScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>Track Applications [Recruiter] - OptaHire</title>
        <meta
          name="description"
          content="OptaHire Recruiter Applications - Track shortlisted applications in one place."
        />
        <meta
          name="keywords"
          content="OptaHire, Recruiter, Applications, Track, Shortlisted"
        />
      </Helmet>
